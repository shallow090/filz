...
mongo_db = mongo_client["cloned_horizonbots"]
...
async def clone(client, message):
    ...
    try:
        ...
        await msg.edit_text(f"⚠️ <b>Bot Error:</b>\n\n<code>{e}</code>\n\n**Kindly forward this message to @dev_shadow to get assistance.**")
